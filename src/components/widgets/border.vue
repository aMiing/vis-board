...
<template id="my-scrollText">
	<div ref="drag" class="drag scrollText" @mousedown="MoveIt" title="静态边框" :uid="item.uid" 
		...
		<div ref="borderWidget" style="position:absolute;width:100%;display:table;height: 100%;">
			...
			:style="{background: item.bgcolor,border:item.borderWidth+'px '+item.borderType+' '+item.borderColor,borderRadius:item.borderRadius+'vw',boxShadow:item.shadowX+'vw '+item.shadowY+'vw '+item.shadowWidth+'vw '+item.shadowColor}">
			</div>
		</div>
	</div>
</template>
