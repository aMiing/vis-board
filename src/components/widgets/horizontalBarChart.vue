...
<template id="my-horizontalBarChart">
	<div ref="drag" class="drag horizontalBarChart" @mousedown="MoveIt" title="水平柱状图" :uid="item.uid"  
		...
		<div ref="horizontalBarChart" style="position:absolute;width:100%;display:table;text-align: center;height: 100%;" 
