...
<template id="my-lineChart">
	<div ref="drag" class="drag lineChart" @mousedown="MoveIt" title="折线图" :uid="item.uid"  
		...
		<div ref="lineChart" style="position:absolute;width:100%;display:table;text-align: center;height: 100%;" 
